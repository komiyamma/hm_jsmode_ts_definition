 ...
 * ※※ このファイルは「hm_jsmode_strict.d.ts」から「make_hm_jsmode_global.exe」によって自動生成されています ※※
 * 
 ...
 *                 https://github.com/komiyamma/hm_jsmode_ts_definition/blob/main/LICENSE    
 * 
 *                 以下に定める条件に従い、「本定義ファイル（hm_jsmode.d.ts と hm_jsmode_strict.d.ts）」および関連ファイルの複製を取得するすべての人に対し、
...
declare namespace hidemaru {
  ...
  interface IProcessInfoStdio {
     ...
     */
    flush(timeout_millisecond: number): number;
  }
   ...
   * (V9.22β12以降は、再取得しても、同じIDを再割り当てするように変更されています）
   */
   ...
   * 同じウィンドウであっても「ファイルを閉じる」「閉じて開く」「ファイル名変更」をすると消去されます。    
   * - 1 を指定すると、全ての秀丸エディタで有効です。    
   * - 2 を指定すると、共有せず、現在の秀丸エディタ内だけで有効です。    
   * 「ファイルを閉じる」「閉じて開く」「ファイル名変更」をしても保持されます。
   ...
   * - 0x00008000 キーやマウスの操作直後(100ms 以内)    
...
declare namespace hidemaruGlobal { /// <# HidemaruGlobalToGlobal bgn #>
  ...
  interface IRenderPaneCommandArg { target?: string, show?: 1 | 0, invisible?: 1 | 0, uri?: string, url?: string, place?: "leftside" | "rightside" | "upside" | "downside" | "overlay", get?: "readyState" | "DOMContentLoaded" | "load" | "show" | "uri" | "url" | "size" | "invisible" | "place" | "initialized", clear?: 1, refresh?: 1, focus?: 1 | 0, align?: "left" | "center" | "right" | "screenleft" | "screencenter" | "screenright", valign?: "top" | "center" | "middle" | "bottom" | "top" | "screencenter" | "screenbottom", x?: string, y?: string, cx?: string, cy?: string, size?: number, initialize?: "async" }
  /**
   * f    
   * [非同期]  
   * 
 ...
 * 値の設定が成功したら１，失敗したら０を返す
 */
declare function setVar(varname: string, newvalue: string | number): number
...
declare function scrolllinkhandle(): number
   ...
   * ブラウザ枠のウィンドウハンドルを数値で返す。
   */
declare function browserpanehandle(target_pane?: IBrowserPaneTarget): number
   ...
   * ブラウザ枠のサイズをピクセル単位で返す。
   */
declare function browserpanesize(target_pane?: IBrowserPaneTarget): number
   ...
   * ブラウザ枠に表示されている現在のコンテンツのURLを文字列で返す。
   */
declare function browserpaneurl(target_pane?: IBrowserPaneTarget): string
...
declare function getcolormarker(target_prop: number, layer_name?: string): string
   ...
   * 取得結果をオブジェクトで返します。 
   */
declare function getcolormarker(json_obj: IGetColorMarkerJsonArg | object): object
...
declare function gotagpair(): number
   ...
   * カーソル移動しなかった場合は０を返す。
   */
declare function backtab(move_step?: number): number
   ...
   * カーソル移動しなかった場合は０を返す。
   */
declare function forwardtab(move_step?: number): number
...
declare function split(split_type?: number, split_switch?: number, split_pos?: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function setsplitinfo(setting_prop: number, setting_value: number): number
...
declare function fullscreen(): number
   ...
   * 成功すると0以外、失敗すると0を返します。
   */
declare function setbrowserpanetarget(default_target: IBrowserPaneTarget): number
...
declare function setrenderpanetarget(default_target: string): number
   ...
   * 成功すると0以外、失敗すると0を返します。
   */
declare function showbrowserpane(show_switch?: -1 | 0 | 1, target_pane?: IBrowserPaneTarget): number
   ...
   * 成功すると0以外、失敗すると0を返します。
   */
declare function refreshbrowserpane(target_pane?: IBrowserPaneTarget): number
...
declare function writeininumw(ini_filepath: string, section_name: string, key_name: string, num_value: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function writeinistr(ini_filepath: string, section_name: string, key_name: string, str_value: string): number
...
declare function writeregbinary(name: string, value: string, seek_cur?: number, write_mode?: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function writeregnum(name: string, num_value: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function writeregstr(name: string, str_value: string): number
...
declare function deletereg(root_key: string, sub_key: string, own_hidemaru_reg?: number): number
   ...
   * 失敗したら0を返します。
   */
declare function configset(setting_name: string, config_state: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function config(setting_expression: IConfigArg): number
...
declare function config(setting_expression: string): number
   ...
   * 返り値は意味を持ちません。
   */
declare function config(json_obj: IConfigJsonArg | object): number;
   ...
   * 取得した情報をJSONオブジェクトで返します。
   */
declare function getconfig(json_obj: IGetConfigJsonArg | {"*":{}} | object): IGetConfigJsonReturn;
   ...
   * 取得する情報によって文字列型と数値型のどちらかが返ります。
   */
declare function getconfig(key: IGetConfigArg): string | number
...
declare function setconfigstate(config_flag: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function setfiletype(extension: string, no_read_setting_file?: number): number
...
declare function setwindowpos(pos_x_left: number, pos_y_top: number): number
   ...
   * 返り値は意味を持ちません。
   */
declare function setwindowpos(pos_x_left: number, pos_y_top: number, pos_x_right: number, pos_y_bottom: number): number
...
declare function findspecial(search_type: number, code: number, search_direction: number): number
   ...
   * 成功した場合、0以外を返す。    
   */
declare function setstaticvariable(key: string, str_value: string, scope_type?: number): number
...
declare function closehidemaruforced(hidemaru_handle: number): number
   ...
   * 引数に対応するようなタブが存在しない時は、-1を返す。
   */
declare function getcurrenttab(id_type: number, tab_group_id: number): number
   ...
   * 引数に対応するようなタブが存在しない時は、-1を返す。
   */
declare function gettabhandle(id_type: number, tab_group_id: number, tab_order: number): number
...
declare function seteventnotify(notify_target: number): number
   ...
   * 
   */
declare function geteventnotify(notify_target: 0 | number): number
